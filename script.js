...
async function postLeaderboard() {
    ...
    if (username == null) console.log('Not logged in');
    try {
        const response = await axios.post('http://localhost:3001/api/v1/leaderboard', {
            username: username,
            wordsPerMinute: parseInt(wpmTag.innerText),
            mistake: parseInt(mistakeTag.innerText),
            category: maxTime,
        });
